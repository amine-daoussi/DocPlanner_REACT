...
function PatientsDoctors (){ 
    ...
    <div className="text-part">
        <p className="text1" >"We want patients to find the perfect doctor and book an appointment in the most easy way.
        ...
        <p className="text2" >"We also help doctors to better manage their practice and build their online reputation.
